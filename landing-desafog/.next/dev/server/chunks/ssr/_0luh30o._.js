...
const metadata = {
    ...
    description: "Controle financeiro com priorização inteligente, plano mensal, simulador de cenários e assistente com IA. Saia do caos das contas com clareza e um plano real.",
    metadataBase: new URL("https://desafog.ai"),
    openGraph: {
        title: "Desafog.ai — Organize suas dívidas, limpe sua visão financeira",
        description: "Priorize dívidas, crie um plano mensal e simule cenários com apoio de IA.",
        type: "website",
        locale: "pt_BR"
    }
};
